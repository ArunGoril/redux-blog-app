...
const PostDetails = () => {
    ...
    return (
        <div className='row m-5'>
            <div className="card col-6 bg-light shadow">
                <div className="card-body">
                    <h5 className="card-title">{post.title}</h5>
                    <h6 className="card-subtitle mb-2 text-muted">Id: {post.id}</h6>
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form onSubmit={(e) => handleOnSubmit(e)}>
                                    ...
                                    <button type="submit" className="btn btn-primary my-3" data-bs-dismiss="modal">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
